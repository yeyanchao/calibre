...
# Form implementation generated from reading ui file '/home/yc/code/calibre/calibre/src/calibre/gui2/preferences/metadata_sources.ui'
#
...
""))
        ...
        self.gridLayout.addWidget(self.groupBox, 0, 0, 8, 1)
        ...
        self.gridLayout.addWidget(self.opt_max_tags, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.opt_wait_after_first_identify_result, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.opt_wait_after_first_cover_result, 7, 2, 1, 1)
...
"<p>Note that this option will only make a practical difference if one of the metadata sources has a genre like tag set for the book you are searching for. Most often, they all have large tag sets."))
        ...
        self.gridLayout.addWidget(self.opt_fewer_tags, 4, 1, 1, 2)
        self.opt_find_first_edition_date = QtGui.QCheckBox(self.page)
        self.opt_find_first_edition_date.setText(_("Use published date of \"first edition\" (from worldcat.org)"))
        self.opt_find_first_edition_date.setObjectName(_fromUtf8("opt_find_first_edition_date"))
