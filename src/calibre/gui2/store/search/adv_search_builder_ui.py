...
# Form implementation generated from reading ui file '/home/yc/code/calibre/calibre/src/calibre/gui2/store/search/adv_search_builder.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.title_box, 1, 2, 1, 1)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_6, 9, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.author_box, 2, 2, 1, 1)
        self.format_box = QtGui.QLineEdit(self.tab_2)
        self.format_box.setObjectName(_fromUtf8("format_box"))
        self.gridLayout.addWidget(self.format_box, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.price_box, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.affiliate_combo, 7, 2, 1, 1)
        self.label_12 = QtGui.QLabel(self.tab_2)
        self.label_12.setText(_("Download:"))
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.gridLayout.addWidget(self.label_12, 6, 0, 1, 1)
        self.download_combo = QtGui.QComboBox(self.tab_2)
        self.download_combo.setObjectName(_fromUtf8("download_combo"))
        self.download_combo.addItem(_fromUtf8(""))
        self.download_combo.setItemText(0, _fromUtf8(""))
        self.download_combo.addItem(_fromUtf8(""))
        self.download_combo.setItemText(1, _("true"))
        self.download_combo.addItem(_fromUtf8(""))
        self.download_combo.setItemText(2, _("false"))
        self.gridLayout.addWidget(self.download_combo, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.drm_combo, 5, 2, 1, 1)
